...
rule all:
    ...
    run:
        ...
        shell("cp Prokka*/*/*txt results_for_multiqc/. 2>> {log.err} | tee -a {log.out}")
        ...
        shell("cp logs/abricate_results/*.summary.csv results_for_multiqc/. 2>> {log.err} | tee -a {log.out}")
        shell("cp logs/benchmark_summary.csv results_for_multiqc/. 2>> {log.err} | tee -a {log.out}")
        shell("cp logs/File_heatmap.csv  results_for_multiqc/. 2>> {log.err} | tee -a {log.out}")
        shell("cp logs/raw_clean_coverage.txt  results_for_multiqc/. 2>> {log.err} | tee -a {log.out}")
        shell("cp logs/raw_clean_scatter.csv  results_for_multiqc/. 2>> {log.err} | tee -a {log.out}")
        ...
        shell("cp run_file_summary.txt results_for_multiqc/. 2>> {log.err} | tee -a {log.out}")
        # running multiqc
